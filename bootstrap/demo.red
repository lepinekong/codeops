Red [
    Title: "bootstrap/demo.red"
]

subscription-form: {<h1 class="margin-base-vertical">Subscribe:</h1>
...
html-body: html.compose/insert/within-div html-body subscription-form "col-md-6 col-md-offset-3"
